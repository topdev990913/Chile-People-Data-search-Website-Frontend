...
const SearchBarName123456 = ({ setListData }) => {
    ...
    return (
        <div className="searchbar_out" onKeyUp={(e) => {
            if (e.key === "Enter") {
                console.log("-------------------")
                axios.post('https://chile-back.onrender.com/students/temp123456', { "name": value, "Address": value1, "Common": value2, "Regeion": value3, "Salud": value4, "Fec_Nac": value5, "DV": value6 })
                        .then((response) => {
